...
Provides SyllableSlotPooler: boundary-constrained cross-attention that
...
class SyllableSlotPooler(nn.Module):
    """Boundary-constrained cross-attention pooling with causal inter-slot refinement.
    ...
    closure bursts) that plain mean pooling discards.
